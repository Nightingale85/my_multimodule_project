 ...
 * http://jquery.com/
 *
 * Includes Sizzle.webapp.veiw.js
 * http://sizzlejs.com/
 *
...
jQuery.extend( {
	...
	when: function( subordinate /* , ..., subordinateN */ ) {
		...
		// Add listener to Deferred subordinates; treat others as resolved
		if ( length > 1 ) {
...
jQuery.event = {
	...
	props: ( "altKey bubbles cancelable ctrlKey currentTarget detail eventPhase " +
		"metaKey relatedTarget shiftKey target timeStamp html which" ).split( " " ),
